      ...
      <div className="inner_top_padding">
        ...
        <div className="container my-5">
          <div className="row pad_bot_create_1">
            ...
            <h2 className="mb-5 title_text_white flex_center_between d-block d-sm-flex faq_tetx_big">Create Single Collectible
            ...
            {({getRootProps, getInputProps}) => (
              ...
              You will receive ETH</p>
                  ...
                  <div className="timed_auction_sec d-none">
                    <div className="row">
                      <div className="col-12">
                      <label className="primary_label" htmlFor="min_bid">Minimum Bid</label>

                  <div className="input-group mb-3">
                  <input type="text" className="form-control primary_inp bor_rit_rad" placeholder="Enter Minimum Bid" aria-label="Recipient's username" aria-describedby="basic-addon3" />
                  <div className="input-group-append">
                    ...
                    <div class="card card_bl_grey my-0 rad_2">
                        <div class="card-body px-2 pt-2 pb-0">
                            <ul className="colors_ul">
                                ...
                                <li data-toggle="modal" data-target="#calendar_modal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">                         
              ...
              <div className="media approve_media">
                ...
                <button className="bg_green_icon pro_complete ml-0" type="button"><i class="fas fa-check"></i></button>
